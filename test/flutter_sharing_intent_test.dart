...
class MockFlutterSharingIntentPlatform
  ...
  Future<List<SharedFile>> getInitialSharing() {
   return Future.value([SharedFile(value: "Test",type:SharedMediaType.TEXT)]);
  }
...
void main() {
  final FlutterSharingIntentPlatform initialPlatform = FlutterSharingIntentPlatform.instance;
  ...
  MockFlutterSharingIntentPlatform fakePlatform = MockFlutterSharingIntentPlatform();
